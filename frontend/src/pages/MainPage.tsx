                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 text-[10px] text-[var(--text-secondary)] font-medium">
                        ...
                        {/* Tags Display - Positioned right of comments */}
                        {item.tags && (
                          <>
                            <span className="opacity-30">|</span>
                    ...
                    {item.image && (
                      <div className="w-16 h-12 rounded-lg overflow-hidden shrink-0 border border-[var(--card-border)] group-hover/item:border-cyan-500/30 transition-colors">
                        <img 
                          src={item.image} 
                          alt="" 
